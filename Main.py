    ...
    while True:  
        ...
        if result == "go":
            ...
            if distance is not None and distance < 15:    
                ...
                for i in range(1,5):
                    hcs.activate_buzzer()  
                motor.move(-0.3, 0, 0.4) #lui
                motor.stop(1)
                motor.move(0.3, 0.5, 0.3) #trai
                motor.stop(1)
                motor.move(0.3, 0, 0.4) #tien
                motor.stop(1)
                motor.move(0.3, -0.5, 0.4) #phai
                motor.stop(1)
                motor.move(0.3, 0, 0.4) #tien
                motor.stop(1)
                motor.move(0.3, 0.5, 0.3) #trai
